...
export async function updateSession(request: NextRequest) {
    ...
    if (!supabaseUrl || !supabaseAnonKey) {
        // If env vars are missing, we can't properly session check.
        // During build/dev without vars, just return the response to avoid crashing.
    ...
    //    the cookies!
    // 4. Finally: return myNewResponse, of course!
